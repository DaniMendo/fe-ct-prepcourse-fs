...
function incrementarPorUno(array) {
   ...
   // Tu código:
   var array1=array.map((num) => {return num+1});
   return array1;
   // otra variante para este modo seria:
   //for (let i=0; i<array.length; i++){
   //   array1[i]=array[i] + 1;
   //}
   //return array1;
...
function multiplicarArgumentos() {
   ...
   if (arguments.length==0) {
      ...
      return multiplicar=arguments[0];
...
function cuentoElementos(array) {
   ...
   // Tu código:
   var cont=0
   for (i=0; i<array.length; i++) {if (array[i]>18){
      cont+=1;
     }
   }return cont;
}
